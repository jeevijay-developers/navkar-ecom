    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23fa8e00' fill-opacity='0.4'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
          }}
        />
      </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                style={{
                  borderColor: "rgba(250, 142, 0, 0.5)",
                  color: "#fa8e00",
                }}
                href="/cart"
                radius="sm"
            ...
            <div
              ...
              style={{ borderTop: "1px solid rgba(250, 142, 0, 0.2)" }}
            >
              <div>
                <p
          ...
          <div className="hidden lg:flex justify-center items-center">
            <div className="relative">
              <div
                ...
                style={{ background: "rgba(250, 142, 0, 0.1)" }}
              />
              <div
