  ...
  if (loading) {
    return (
      <div className="space-y-0">
        {/* Hero Skeleton */}
        <div className="bg-gray-300 pt-24 pb-16">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="h-16 w-3/4 rounded-lg bg-gray-100 animate-pulse" />
                <div className="h-20 w-full rounded-lg bg-gray-100 animate-pulse" />
                <div className="flex gap-4">
                  <div className="h-12 w-40 rounded-lg bg-gray-100 animate-pulse" />
                  <div className="h-12 w-40 rounded-lg bg-gray-100 animate-pulse" />
                </div>
              </div>
        ...
        <div className="py-20 max-w-7xl mx-auto px-6">
          <div className="space-y-4 text-center mb-12">
            <div className="h-10 w-64 rounded-lg mx-auto bg-gray-100 animate-pulse" />
            <div className="h-6 w-96 rounded-lg mx-auto bg-gray-100 animate-pulse" />
          </div>
